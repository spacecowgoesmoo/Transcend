...
function updateTextSpans(recursionTime) {
	...
	if (cow.diamondCapacity >= 17 && cow.maxDiamondCapacity == 20 && cow.endgameBarOwned == true) { 	diamondMaxCapacity30PurchaseButton.style.display = 'inline'; 	s++; } 		else { diamondMaxCapacity30PurchaseButton.style.display = 'none'; }
	...
	if (cow.starCapacity >= 17 && cow.maxStarCapacity == 20 && cow.endgameBarOwned == true) { 			starMaxCapacity30PurchaseButton.style.display = 'inline'; 		s++; } 		else { starMaxCapacity30PurchaseButton.style.display = 'none'; }
	...
	if (cow.hexagonCapacity >= 17 && cow.maxHexagonCapacity == 20 && cow.endgameBarOwned == true) { 	hexagonMaxCapacity30PurchaseButton.style.display = 'inline'; 	s++; } 		else { hexagonMaxCapacity30PurchaseButton.style.display = 'none'; }
	...
	if (cow.triangleCapacity >= 17 && cow.maxTriangleCapacity == 20 && cow.endgameBarOwned == true) {	triangleMaxCapacity30PurchaseButton.style.display = 'inline'; 	s++; } 		else { triangleMaxCapacity30PurchaseButton.style.display = 'none'; }
	...
	if (cow.circleCapacity >= 17 && cow.maxCircleCapacity == 20 && cow.endgameBarOwned == true) { 		circleMaxCapacity30PurchaseButton.style.display = 'inline'; 	s++; } 		else { circleMaxCapacity30PurchaseButton.style.display = 'none'; }
	...
	if (cow.squareCapacity >= 170 && cow.maxSquareCapacity == 200 && cow.endgameBarOwned == true) { 	squareMaxCapacity300PurchaseButton.style.display = 'inline';	s++; } 		else { squareMaxCapacity300PurchaseButton.style.display = 'none'; }
